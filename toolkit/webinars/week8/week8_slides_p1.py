...
import datetime as dt
bday_start = dt.datetime(year=2000, month=12, day=2)
dt_now = dt.datetime.now()
alive = dt_now - bday_start
secs_alive = alive.days * 24 * 60 * 60 + alive.seconds
print(f'I have been alive for {secs_alive} seconds.')

# 2. How old will you be in 1,340 days
days = dt.timedelta(days=1340)
future_date = dt.datetime.now() + days
alive = future_date - bday_start
age = alive.days/365
print(f'I will be {age} years old in 1,340 days.')
